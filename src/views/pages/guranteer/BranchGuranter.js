...
const BranchGuranter = () => {
  ...
  const fetchData = useCallback(async () => {
    try {
      const [usersResponse, routeResponse, branchResponse] = await Promise.all([
        Axios.get(process.env.REACT_APP_API_ENDPOINT + '/guarantor/all', {
  ...
  const table = {
    ...
    editing: {
      ...
      updateApi: '/guarantor/update/'
    },

    delete: {
      deleteType: 'mix', //single | multiple | mix
      deleteApi: '/guarantor/delete/',
      singleDeleteApi: '/guarantor/delete/'
    },
    pagination: {
